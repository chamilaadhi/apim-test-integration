...
helm install $project_name wso2/am-pattern-1 --version 3.2.0-5 --namespace $namespace --create-namespace --set wso2.analytics.dashboard.replicas=0 --set wso2.analytics.worker.resources.requests.memory=1G --set wso2.analytics.worker.resources.requests.cpu=1000m
